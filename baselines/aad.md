...
**NLS Assessment Tool — Baseline Documentation**
...
This baseline defines the security configuration requirements for Microsoft Entra ID as assessed by the NLS Assessment Tool. Each control maps to one or more security frameworks and produces a finding of **Satisfied**, **Partial**, **Gap**, or **N/A**.
