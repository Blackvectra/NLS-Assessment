...
function Publish-NLSRemediationPlaybook {
    ...
    if ($HtmlOutputPath) {
        ...
        $null = $html.AppendLine("<div class=`"meta`"><b>Client:</b> $(H $client) &middot; <b>Assessment Date:</b> $(H $date) &middot; <b>Tool:</b> NLS-Assessment v$(H $version)</div>")
        ...
        $null = $html.AppendLine("<hr><div class=`"meta`">Generated by NLS-Assessment v$(H $version) &middot; $(H $date)</div>")
